...
namespace {
    ...
    class RCache extends \Le2B\RCache {

        /**
         * Функция возвращает данные из кэша
         *
         ...
         * @static
         */
        public static function get($appname, $aid, $asArray = false){
            return \Le2B\RCache::get($appname, $aid, $asArray);
        }

        /**
         * Функция кеширует данные $data по идентификатору $id на время $time в секундах
         *
         * @param string $appname
         * @param string $aid
         * @param string $data
         ...
         * @static
         */
        public static function set($appname, $aid, $data, $time = 0){
            return \Le2B\RCache::set($appname, $aid, $data, $time);
        }

        /**
         * Очищает все данные в кеш по маске
         *
         * @param string $appname
         * @param string $aid
         *
         ...
         * @static
         */
        public static function proper($appname, $aid = null){
            return \Le2B\RCache::proper($appname, $aid);
        }
    }
